...
public class Match {
	...
	//only using those fields whose data has been fetched from website
	...
	// to fetch the date of live match only
	...
	// set the match status according to textComplete, custom setter
